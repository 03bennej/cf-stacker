""" Non-negative matrix factorization with support for missing values

Adapted from:
https://scikit-learn.org/stable/modules/generated/sklearn.decomposition.NMF.html

This code is adapted from Tom Dupre la Tour's NMF for missing values. More here:
...
from validation import check_is_fitted, check_non_negative
...
class NMF(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, n_components=None, init=None, solver='cd',
        ...
        self.update_H = update_H # added to allow fixing matrix
    ...
    def fit_transform(self, X, y=None, W=None, H=None):
        ...
        W, H, n_iter_ = non_negative_factorization(
            ...
            update_H=self.update_H, solver=self.solver, beta_loss=self.beta_loss,
    ...
    def transform(self, X):
        ...
        W, _, n_iter_ = non_negative_factorization(
            ...
            init=self.init, update_H=self.update_H, solver=self.solver,
